...
import { useContentHubStore, type Post } from "../store"
...
const generatePostShareData = (post: Post): ShareData => {
    ...
    return {
        ...
        text: post.description.length > 100 ? `${post.description.substring(0, 100)}...` : post.description,
        url: postUrl,
    }
}
...
const PostDetail = ({
    ...
    <div>
        <button onClick={onBack} className="mb-6 flex items-center text-lime-400 hover:text-lime-300 transition-colors">
        ...
        <div className="bg-gray-900 border border-lime-400/20 rounded-xl p-6">
            <div className="flex items-center space-x-3 mb-4">
                <div className="w-10 h-10 bg-lime-400 rounded-full flex items-center justify-center">
                    <span className="text-black font-bold">{post.author.username.charAt(0).toUpperCase()}</span>
                </div>
                <div>
                                    ...
                                    <div className="p-4 pt-2">
                                        ...
                                        <div className="flex items-center justify-between mt-3">
                                            ...
                                            >
                                                ...
                                                <span className="text-xs font-medium">{isWebShareSupported() ? "Share" : "Copy Link"}</span>
                                            </button>
