      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-2xl lg:text-3xl font-bold text-white">Player Spotlight</h1>
              <p className="text-gray-400 text-sm">Celebrating outstanding talent in the BEFA community</p>
            </div>
            <button
        ...
        {/* Player of the Month */}
        {playerOfTheMonth ? (
          <div className="bg-gradient-to-r from-lime-400/10 to-lime-500/10 border border-lime-400/20 rounded-2xl p-6 lg:p-8 mb-8">
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              <div className="text-center lg:text-left">
                <div className="mx-auto lg:mx-0 w-64 h-64 lg:w-72 lg:h-72 rounded-xl overflow-hidden border-4 border-lime-400/30 mb-4">
                  <img
                    src={playerOfTheMonth.image || "/drilldown.png"}
                ...
                >
                  <div className="flex items-center space-x-4 mb-4">
                    <div className="w-16 h-16 rounded-xl overflow-hidden border-2 border-lime-400/30">
                      <img
                        src={player.image || "/drilldown.png"}
                        alt={player.name}
                        className="w-full h-full object-cover"
                        onError={(e) => {
                          (e.target as HTMLImageElement).src = "/drilldown.png";
