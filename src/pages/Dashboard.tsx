...
const Dashboard: React.FC = () => {
    ...
    const handleWhatsAppChannel = () => {
        window.open("https://whatsapp.com/channel/0029Vb6p1cw17EmxfuyKfQ1y", "_blank")
    }

    const handleWhatsAppFanGroup = () => {
        window.open("https://chat.whatsapp.com/your-fan-group-link", "_blank")
    }
                    ...
                    <div className="min-h-screen bg-black text-white pt-20">
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                            ...
                            <div className="mt-12 flex flex-col sm:flex-row gap-4 justify-center items-center">
                                ...
                                <button
                                    onClick={handleWhatsAppFanGroup}
